...
const HomeContent: FC<any> = ({ contentIndex }) => {
  ...
  useEffect(() => {
    const routerSwitch = async (): Promise<void> => {
      await new Promise(() => router.push(homeContent[contentIndex].href));
    };
      ...
      <section className={`section${sectionJoinedClassStates}`}>
        <div className="section-info">
          <div
            ...
            onAnimationEnd={() => {}}
          >
            <h1 className="section-title">{homeContent[contentIndex].title}</h1>
            <p className="section-para">
              {homeContent[contentIndex].bodyDescription}
            </p>
            <Link
              href={homeContent[contentIndex].href}
              className={`section-button${sectionButtonJoinedClassStates}`}
              onClick={() => {}}
            >
              <span>{homeContent[contentIndex].buttonText}</span>
              <div>
        ...
        <Image
          ...
          src={homeContent[contentIndex].imageSrc}
          alt=""
